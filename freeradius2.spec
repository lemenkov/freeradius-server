...
%description oracle
This plugin provides the Oracle support for the FreeRADIUS server project.
%endif
...
%configure \
        ...
        --without-rlm_sql_db2 \
%if 0%{?_with_oracle}
        --with-oracle-include-dir=$ORACLE_HOME/include \
        --with-oracle-lib-dir=yes
%else
...
%{_libdir}/freeradius/rlm_sql_oracle-%{version}.so
%endif
...
%changelog
* Tue Sep 25 2012 John Dennis <jdennis@redhat.com> - 2.1.12-4
- resolves: bug#855315
...
* Thu Jan  5 2012 John Dennis <jdennis@redhat.com> - 2.1.12-3
- resolves: bug#756442
  also fixes bug#760193

* Wed Nov 23 2011 John Dennis <jdennis@redhat.com> - 2.1.12-2
- resolves: bug#609633
  Fix certificate creation regression described in 756442
...
* Mon Sep 19 2011 John Dennis <jdennis@redhat.com> - 2.1.7-8
- resolves: bug#658508 - /etc/pam.d/radiusd uses non-existent password-auth
  module instead of system-auth

* Wed Dec 30 2009 John Dennis <jdennis@redhat.com> - 2.1.7-7
- resolves: bug #550845 - freeradius2-devel has multilib conflicts
